        ...
        <div className="flex flex-col gap-[50px] max-w-1/2 w-[90%] mx-auto justify-center h-full">
          ...
          <div className="text-[18px]">
            <input
              ...
              className="placeholder:text-black placeholder:text-[18px] p-[20px] rounded-[59px] w-[50%] bg-loupeIcon bg-no-repeat bg-[95%] bg-[length:20px]"
            />
          </div>
        </div>

        <div className="h-[550px] bg-[#E3E1DC] rounded-b-[42px] ">
          <div className="max-w-1/2 w-[90%] mx-auto h-full pt-[40px]">
            <span className="text-[18px]">Most Searched Breeds</span>
          </div>
        </div>
      </div>
    </div>
